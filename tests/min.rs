...
#[test]
fn test_min_valid_empty_string() {
    let mut params = Map::new();
...
#[test]
fn test_min_invalid_low_string() {
    let mut params = Map::new();
    params.assign("size", Value::String("foo".to_owned())).ok();
    ...
    assert_eq!(*result.unwrap_err().get("size").unwrap(),
               vec!["The size field must be at least 5 characters.".to_owned()]);
}

#[test]
fn test_min_valid_u64() {
    let mut params = Map::new();
...
fn test_min_invalid_low_u64() {
    ...
    assert!(result.is_err());
    assert_eq!(*result.unwrap_err().get("size").unwrap(),
               vec!["The size field must be at least 5.".to_owned()]);
}

#[test]
fn test_min_valid_u64_below_0() {
    let mut params = Map::new();
    params.assign("size", Value::U64(1)).ok();
...
fn test_min_invalid_low_i64() {
    ...
    assert!(result.is_err());
    assert_eq!(*result.unwrap_err().get("size").unwrap(),
               vec!["The size field must be at least 4.".to_owned()]);
}

#[test]
fn test_min_valid_array() {
    let mut params = Map::new();
...
fn test_min_invalid_low_array() {
    ...
    assert!(result.is_err());
    assert_eq!(*result.unwrap_err().get("size").unwrap(),
               vec!["The size field must have at least 8 items.".to_owned()]);
}

#[test]
fn test_min_valid_object() {
    let mut params = Map::new();
...
#[test]
fn test_min_valid_empty_object() {
    let mut params = Map::new();
...
#[test]
fn test_min_invalid_low_object() {
    let mut params = Map::new();
    let mut items = Map::new();
    items.assign("foo", Value::U64(1)).ok();
    items.assign("bar", Value::U64(2)).ok();
...
fn test_min_invalid_low_file() {
    ...
    assert!(result.is_err());
    assert_eq!(*result.unwrap_err().get("size").unwrap(),
               vec!["The size must be at least 8 kilobytes.".to_owned()]);
}

#[test]
fn test_min_valid_blank() {
    let params = Map::new();
